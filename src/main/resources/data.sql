...
INSERT INTO categories(name, subject_id) VALUES ('Spring', 1);
-- INSERT INTO categories(name, subject_id) VALUES ('Hibernate', 1);
...
INSERT INTO questions(content, category_id) VALUES ('Объясните суть паттерна DI или IoC.', 12);
INSERT INTO questions(content, category_id) VALUES ('Какие преимущества применения Dependency Injection (DI)?', 12);
INSERT INTO questions(content, category_id) VALUES ('Что такое AOP? Как это относиться к IoC?', 12);
INSERT INTO questions(content, category_id) VALUES ('Что такое Aspect, Advice, Pointcut, JointPoint и Advice Arguments в АОП?', 12);
INSERT INTO questions(content, category_id) VALUES ('Что такое IoC контейнер Spring?', 12);
INSERT INTO questions(content, category_id) VALUES ('Что такое Spring бин?', 12);
INSERT INTO questions(content, category_id) VALUES ('Какое значение имеет конфигурационный файл Spring Bean?', 12);
INSERT INTO questions(content, category_id) VALUES ('Какие вы знаете scope у Spring Bean?', 12);
INSERT INTO questions(content, category_id) VALUES ('Что такое жизненный цикл Spring Bean?', 12);
INSERT INTO questions(content, category_id) VALUES ('В чем роль ApplicationContext в Spring?', 12);
INSERT INTO questions(content, category_id) VALUES ('Что такое связывание в Spring и расскажите об аннотации @Autowired?', 12);
INSERT INTO questions(content, category_id) VALUES ('Каковы различные типы автоматического связывания в Spring?', 12);
INSERT INTO questions(content, category_id) VALUES ('Приведите пример часто используемых аннотаций Spring.', 12);
INSERT INTO questions(content, category_id) VALUES ('Можем ли мы послать объект как ответ метода обработчика контроллера?', 12);
INSERT INTO questions(content, category_id) VALUES ('Является ли Spring бин потокобезопасным?', 12);
INSERT INTO questions(content, category_id) VALUES ('Как создать ApplicationContext в программе Java?', 12);
INSERT INTO questions(content, category_id) VALUES ('Можем ли мы иметь несколько файлов конфигурации Spring?', 12);
INSERT INTO questions(content, category_id) VALUES ('Как внедрить java.util.Properties в Spring Bean?', 12);
INSERT INTO questions(content, category_id) VALUES ('Как настраивается соединение с БД в Spring?', 12);
INSERT INTO questions(content, category_id) VALUES ('Каким образом можно управлять транзакциями в Spring?', 12);
INSERT INTO questions(content, category_id) VALUES ('Каким образом Spring поддерживает DAO?', 12);
INSERT INTO questions(content, category_id) VALUES ('Как интегрировать Spring и Hibernate?', 12);
INSERT INTO questions(content, category_id) VALUES ('Как добавить поддержку Spring в web-приложение', 12);
INSERT INTO questions(content, category_id) VALUES ('Что такое контроллер в Spring MVC?', 12);
INSERT INTO questions(content, category_id) VALUES ('Какая разница между аннотациями @Component, @Repository и @Service в Spring?', 12);
INSERT INTO questions(content, category_id) VALUES ('Расскажите, что вы знаете о DispatcherServlet и ContextLoaderListener.', 12);
INSERT INTO questions(content, category_id) VALUES ('Что такое ViewResolver в Spring?', 12);
INSERT INTO questions(content, category_id) VALUES ('Что такое MultipartResolver и когда его использовать?', 12);
INSERT INTO questions(content, category_id) VALUES ('Как загрузить файл в Spring MVC?', 12);
INSERT INTO questions(content, category_id) VALUES ('Как обрабатывать исключения в Spring MVC Framework?', 12);
INSERT INTO questions(content, category_id) VALUES ('Каковы минимальные настройки, чтобы создать приложение Spring MVC?', 12);
INSERT INTO questions(content, category_id) VALUES ('Как мы можем использовать Spring для создания веб-службы RESTful, возвращающей JSON?', 12);
INSERT INTO questions(content, category_id) VALUES ('Как проверить (валидировать) данные формы в Spring Web MVC Framework?', 12);
INSERT INTO questions(content, category_id) VALUES ('Что вы знаете Spring MVC Interceptor и как он используется?', 12);
INSERT INTO questions(content, category_id) VALUES ('Расскажите о Spring Security.', 12);
